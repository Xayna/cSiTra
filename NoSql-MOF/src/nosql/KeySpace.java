 ...
 * <em><b>Key Space</b></em>'. <!-- end-user-doc -->
 *
 * <p>
...
public interface KeySpace extends EObject {
	...
	/**
	 * Sets the value of the '{@link nosql.KeySpace#getName <em>Name</em>}'
	...
	/**
	 * Returns the value of the '<em><b>Idexes</b></em>' containment reference
	 * list. The list contents are of type {@link nosql.Index}. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Idexes</em>' containment reference list isn't
	...
	/**
	 * Sets the value of the '<em><b>Idexes</b></em>' containment reference
	 * list. The list contents are of type {@link nosql.Index}. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Idexes</em>' containment reference list isn't
	 ...
	 * @generated
	 */
	 void setIdexes(EList indexes);

	/**
	 * Returns the value of the '<em><b>Families</b></em>' containment reference
	 * list. The list contents are of type {@link nosql.ColumnFamily}. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Families</em>' containment reference list
	...
	/**
	 * Sets the value of the '<em><b>Families</b></em>' containment reference
	 * list. The list contents are of type {@link nosql.ColumnFamily}. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Families</em>' containment reference list
	 ...
	 * @generated
	 */
	void setFamilies(EList families);
	...
	/**
	 * Sets the value of the '{@link nosql.KeySpace#getEReference0
	 ...
	 * list. The list contents are of type {@link nosql.Options}. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Options</em>' containment reference list isn't
	 * clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '<em><b>Options</b></em>' containment reference
	 * list. The list contents are of type {@link nosql.Options}. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Options</em>' containment reference list isn't
	 ...
	 * @generated
	 */
	void getOptions(EList options);

	/**
	 * Returns the value of the '<em><b>Has PK</b></em>' containment reference
	 * list. The list contents are of type {@link nosql.PK}. <!-- begin-user-doc
	 * -->
	 * <p>
	 * If the meaning of the '<em>Has PK</em>' containment reference list isn't
	 * clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '<em><b>Has PK</b></em>' containment reference
	 * list. The list contents are of type {@link nosql.PK}. <!-- begin-user-doc
	 * -->
	 * <p>
	 * If the meaning of the '<em>Has PK</em>' containment reference list isn't
