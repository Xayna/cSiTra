 ...
 *   <li>{@link metamodel.impl.ColumnImpl#getReferences <em>References</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ColumnImpl extends MinimalEObjectImpl.Container implements Column {
	 ...
	 * @ordered
	 */
	protected EList<Constraint> references;
	 ...
	 * @generated
	 */
	public EList<Constraint> getReferences() {
		if (references == null) {
			references = new EObjectContainmentEList<Constraint>(Constraint.class, this, MetamodelPackage.COLUMN__REFERENCES);
		}
		return references;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MetamodelPackage.COLUMN__REFERENCES:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MetamodelPackage.COLUMN__REFERENCES:
				getReferences().clear();
				getReferences().addAll((Collection<? extends Constraint>)newValue);
				return;
		}
