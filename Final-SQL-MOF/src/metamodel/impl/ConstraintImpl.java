 ...
 *   <li>{@link metamodel.impl.ConstraintImpl#getReferences <em>References</em>}</li>
...
public class ConstraintImpl extends MinimalEObjectImpl.Container implements Constraint {
	 ...
	 * @ordered
	 */
	protected EList<Column> references;
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.CONSTRAINT__NAME, oldName, name));
	}
	 ...
	 * @generated
	 */
	public EList<Column> getReferences() {
		if (references == null) {
			references = new EObjectContainmentEList<Column>(Column.class, this, MetamodelPackage.CONSTRAINT__REFERENCES);
		}
		return references;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MetamodelPackage.CONSTRAINT__NAME:
				return getName();
